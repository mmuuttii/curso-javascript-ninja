...
console.log(`A soma de ${number1} e ${number2} é igual ${sum(number1, number2)}.`)
...
- Essa fufunção deve retornar uma segunda função que fará o seguinte:
